module.exports = {
  WeakAuraBlacklist: /\b((getfenv|setfenv|loadstring|pcall|SendMail|SetTradeMoney|AddTradeMoney|PickupTradeMoney|PickupPlayerMoney|TradeFrame|MailFrame|EnumerateFrames|RunScript|AcceptTrade|SetSendMailMoney|EditMacro|SlashCmdList|DevTools_DumpCommand|hash_SlashCmdList|CreateMacro|SetBindingMacro|GuildDisband|GuildUninvite|securecall|SendMailMailButton|SendMailMoneyGold|MailFrameTab2)([\s]*\([^\)]*\))?)\b/g,
