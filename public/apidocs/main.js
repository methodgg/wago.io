require.config({
    paths: {
        bootstrap: '/api/docs/vendor/bootstrap.min',
        diffMatchPatch: '/api/docs/vendor/diff_match_patch.min',
        handlebars: '/api/docs/vendor/handlebars.min',
        handlebarsExtended: '/api/docs/utils/handlebars_helper',
        jquery: '/api/docs/vendor/jquery.min',
        locales: '/api/docs/locales/locale',
        lodash: '/api/docs/vendor/lodash.min',
        pathToRegexp: '/api/docs/vendor/path-to-regexp/index',
        prettify: '/api/docs/vendor/prettify/prettify',
        semver: '/api/docs/vendor/semver.min',
        utilsSampleRequest: '/api/docs/utils/send_sample_request',
        webfontloader: '/api/docs/vendor/webfontloader'
    },
    shim: {
        bootstrap: {
            deps: ['jquery']
...
require([
    ...
    'locales',
    'handlebarsExtended',
    '/api/docs/api_project.js',
    '/api/docs/api_data.js',
    'prettify',
    'utilsSampleRequest',
    'semver',
    'webfontloader',
    ...
    // custom wago, put menu in its place and fill in default api keys
    var $window = $(window),
       $stickyEl = $('#sidenav'),
    ...
    if (typeof default_api_key=='string')
        $("input[data-sample-request-param-name='apikey']").val(default_api_key)
