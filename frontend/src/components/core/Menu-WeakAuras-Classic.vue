<template>
  <div id="search-weakaura">
    ...
    <md-layout>
      <addon-info addon="weakaura" expansion="classic"></addon-info>
    </md-layout>
    <md-layout>
      <md-layout>
      ...
      <md-layout>
        ...
        <md-list class="md-double-line md-dense">
          <md-list-item v-for="raid in classicRaids" v-bind:key="raid.id" :class="raid.id + ' md-inset'">
            <div class="menu-image"></div>
            <div class="md-list-text-container">
...
export default {
  ...
  methods: {
    ...
    searchRoute: function (item) {
      ...
      this.$store.commit('setSearchText', `expansion:classic type:WEAKAURA category:${item.id}`)
      this.$router.push('/classic-weakauras/' + item.slug)
    }
  },
  data: function () {
    return {
  ...
  computed: {
    ...
    ptr: function () {
      return window.Categories.raidCategories(['raideternalpalace'])
    },
    misc: function () {
      return window.Categories.getCategories(['gen1', 'gen7', 'gen2', 'gen6', 'gen9', 'gen10', 'gen11', 'gen12', 'gen14', 'gen13', 'gen8', 'gen15', 'gen16', 'gen17'], null, 'WEAKAURA', 'classic')
    },
    roles: function () {
      return window.Categories.getCategories(['role4', 'role1', 'role2', 'role3'])
    },
    pvp: function () {
      return window.Categories.getCategories([/^(arena|bg|wpvp1?)$/], null, 'WEAKAURA', 'classic')
    },
    mechanics: function () {
      return window.Categories.getCategories([/^mech[\d]+/], null, 'WEAKAURA', 'classic')
    },
    equip: function () {
      return window.Categories.getCategories([/^equip[\d]+/, 'legen'], null, 'WEAKAURA', 'classic')
    },
    professions: function () {
      return window.Categories.professionCategories('WEAKAURA', 'classic')
    },
