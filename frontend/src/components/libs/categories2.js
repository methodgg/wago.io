...
class Categories {
  constructor () {
    this.categories = {
      ...
      'cl6-1': {slug: 'classes/death-knight/blood', i18n: 'warcraft:specs.250', domain: 0, parent: 'cl6', games: ['legion', 'bfa', 'sl']},
      'cl6-2': {slug: 'classes/death-knight/frost', i18n: 'warcraft:specs.251', domain: 0, parent: 'cl6', games: ['legion', 'bfa', 'sl']},
      'cl6-3': {slug: 'classes/death-knight/unholy', i18n: 'warcraft:specs.252', domain: 0, parent: 'cl6', games: ['legion', 'bfa', 'sl']},

      'cl12': {slug: 'classes/demon-hunter', image: 'demonhunter.png', color: '#A330C9', i18n: 'warcraft:classes.12', domain: 0, games: ['legion', 'bfa', 'sl']},
      'cl12-1': {slug: 'classes/demon-hunter/havoc', cls:'cl-demonhunter', i18n: 'warcraft:specs.577', domain: 0, parent: 'cl12', games: ['legion', 'bfa', 'sl']},
      'cl12-2': {slug: 'classes/demon-hunter/vengeance', i18n: 'warcraft:specs.581', domain: 0, parent: 'cl12', games: ['legion', 'bfa', 'sl']},
      ...
      'cl11-3': {slug: 'classes/druid/guardian', i18n: 'warcraft:specs.104', domain: 0, parent: 'cl11', games: ['legion', 'bfa', 'sl']},
      ...
      'cl10-1': {slug: 'classes/monk/brewmaster', i18n: 'warcraft:specs.268', domain: 0, parent: 'cl10', games: ['legion', 'bfa', 'sl']},
      'cl10-2': {slug: 'classes/monk/mistweaver', i18n: 'warcraft:specs.270', domain: 0, parent: 'cl10', games: ['legion', 'bfa', 'sl']},
      'cl10-3': {slug: 'classes/monk/windwalker', i18n: 'warcraft:specs.269', domain: 0, parent: 'cl10', games: ['legion', 'bfa', 'sl']},
      ...
      'cl4-2': {slug: 'classes/rogue/outlaw', i18n: 'warcraft:specs.260', domain: 0, parent: 'cl4', games: ['legion', 'bfa', 'sl']},
      ...
      // classic
      'raidnaxxramas': {slug: 'pve/naxxramas', image: 'naxxramas.png', color: '#B3ACAC', i18n: 'warcraft:instances.754', domain: 0, types: ['WEAKAURA', 'COLLECTION'], games: ['classic']},
      'raidnaxxramas1': {slug: 'pve/naxxramas/anub-rekhan', i18n: 'warcraft:encounters.1601', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas2': {slug: 'pve/naxxramas/grand-widow-faerlina', i18n: 'warcraft:encounters.1602', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas3': {slug: 'pve/naxxramas/maexxna', i18n: 'warcraft:encounters.1603', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas4': {slug: 'pve/naxxramas/noth-the-plaguebringer', i18n: 'warcraft:encounters.1604', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas5': {slug: 'pve/naxxramas/heigan-the-unclean', i18n: 'warcraft:encounters.1605', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas6': {slug: 'pve/naxxramas/loatheb', i18n: 'warcraft:encounters.1606', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas7': {slug: 'pve/naxxramas/patchwerk', i18n: 'warcraft:encounters.1610', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas8': {slug: 'pve/naxxramas/grobbulus', i18n: 'warcraft:encounters.1611', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas9': {slug: 'pve/naxxramas/gluth', i18n: 'warcraft:encounters.1612', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas10': {slug: 'pve/naxxramas/thaddius', i18n: 'warcraft:encounters.1613', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas11': {slug: 'pve/naxxramas/instructor-razuvious', i18n: 'warcraft:encounters.1607', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas12': {slug: 'pve/naxxramas/gothik-the-harvester', i18n: 'warcraft:encounters.1608', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas13': {slug: 'pve/naxxramas/the-four-horsemen', i18n: 'warcraft:encounters.1609', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas14': {slug: 'pve/naxxramas/sapphiron', i18n: 'warcraft:encounters.1614', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      'raidnaxxramas15': {slug: 'pve/naxxramas/kel-thuzad', i18n: 'warcraft:encounters.1615', domain: 0, parent: 'raidnaxxramas', types: ['WEAKAURA'], games: ['classic']},
      ...
      'prof10': {slug: 'professions/crafting/inscription', i18n: 'warcraft:professions.773', domain: 0, parent: 'prof5', types: ['WEAKAURA', 'OPIE'], games: ['legion', 'bfa', 'sl']},
      'prof11': {slug: 'professions/crafting/jewelcrafting', i18n: 'warcraft:professions.755', domain: 0, parent: 'prof5', types: ['WEAKAURA', 'OPIE'], games: ['tbc', 'legion', 'bfa', 'sl']},
