...
class Categories {
  constructor () {
    this.categories = {
      ...
      'midnight-mdt-s1': {slug: 'pve/midnight-dungeons-s1', image: 'dungeon.png', color: '#F5A623', i18n: 'Season 1 Dungeons', domain: 0, types: ['MDT'], games: ['tww']},
      'midnight-mdt-s1-1': {slug: 'pve/midnight-dungeons-s1/algethar-academy', i18n: 'warcraft:instances.1201', domain: 0, parent: 'midnight-mdt-s1', mdtID: 45, types: ['MDT'], games: ['tww']},
      'midnight-mdt-s1-2': {slug: 'pve/midnight-dungeons-s1/magisters-terrace', i18n: 'warcraft:instances.249', domain: 0, parent: 'midnight-mdt-s1', mdtID: 153, types: ['MDT'], games: ['tww']},
      'midnight-mdt-s1-3': {slug: 'pve/midnight-dungeons-s1/maisara-caverns', i18n: 'warcraft:instances.1315', domain: 0, parent: 'midnight-mdt-s1', mdtID: 154, types: ['MDT'], games: ['tww']},
      'midnight-mdt-s1-4': {slug: 'pve/midnight-dungeons-s1/nexus-point-xenas', i18n: 'warcraft:instances.1316', domain: 0, parent: 'midnight-mdt-s1', mdtID: 155, types: ['MDT'], games: ['tww']},
      'midnight-mdt-s1-5': {slug: 'pve/midnight-dungeons-s1/pit-of-saron', i18n: 'warcraft:instances.278', domain: 0, parent: 'midnight-mdt-s1', mdtID: 150, types: ['MDT'], games: ['tww']},
      'midnight-mdt-s1-6': {slug: 'pve/midnight-dungeons-s1/seat-of-the-triumvirate', i18n: 'warcraft:instances.945', domain: 0, parent: 'midnight-mdt-s1', mdtID: 11, types: ['MDT'], games: ['tww']},
      ...
      'opie4': {slug: 'opie-equipment', image: 'opie.png', color: '#2595E6', parent: 'opie0', i18n: 'Equipment', domain: 0, types: ['OPIE']},
      ...
      'totalrp1': {slug: 'totalrp-campaigns', image: 'trpcamp.png', color: '#C3793A', i18n: 'Campaigns', domain: 0, types: ['TOTALRP3']},
      'totalrp2': {slug: 'totalrp-campaigns/alliance-campaigns', i18n: 'Alliance Campaigns', domain: 0, parent: 'totalrp1', types: ['TOTALRP3']},
      'totalrp3': {slug: 'totalrp-campaigns/horde-campaigns', i18n: 'Horde Campaigns', domain: 0, parent: 'totalrp1', types: ['TOTALRP3']},
      'totalrp4': {slug: 'totalrp-items', image: 'equipment.png', color: '#7ED321', i18n: 'Items', domain: 0, types: ['TOTALRP3']},
      'totalrp6': {slug: 'totalrp-items/containers', i18n: 'Containers', domain: 0, parent: 'totalrp4', types: ['TOTALRP3']},
      'totalrp7': {slug: 'totalrp-items/documents', i18n: 'Documents', domain: 0, parent: 'totalrp4', types: ['TOTALRP3']},
      'totalrp8': {slug: 'totalrp-items/equipment', i18n: 'Equipment', domain: 0, parent: 'totalrp4', types: ['TOTALRP3']},
      'totalrp9': {slug: 'totalrp-items/expert-mode', i18n: 'Expert Mode', domain: 0, parent: 'totalrp4', types: ['TOTALRP3']},
      'totalrp10': {slug: 'totalrp-items/normal-mode', i18n: 'Normal Mode', domain: 0, parent: 'totalrp4', types: ['TOTALRP3']},
      'totalrp11': {slug: 'totalrp-items/miscellaneous', i18n: 'Miscellaneous', domain: 0, parent: 'totalrp4', types: ['TOTALRP3']},
      'totalrp12': {slug: 'totalrp-items/toys', i18n: 'Toys', domain: 0, parent: 'totalrp4', types: ['TOTALRP3']},
      'rplang0': {slug: 'totalrp-english', image: 'lang.png', color: '#269C7D', i18n: 'Language', domain: 0, types: ['TOTALRP3']},
      'rplang1': {slug: 'totalrp-english', image: 'lang.png', color: '#269C7D', i18n: 'English', parent: 'rplang0', domain: 0, types: ['TOTALRP3']},
      'rplang2': {slug: 'totalrp-french', image: 'lang.png', color: '#269C7D', i18n: 'French', parent: 'rplang0', domain: 0, types: ['TOTALRP3']},
      ...
      'cell4': {slug: 'cell-click-castings', image: 'cell.png', color: '#56E93E', i18n: 'Click Castings', domain: 0, parent: 'cell0', system: true, types: ['CELL']},
      ...
      'bbp4': {slug: 'bbp-totem-indicators', image: 'bbp.png', color: '#217DD3', i18n: 'Totem Indicator List', parent: 'bbp0', domain: 0, system: true},
      'bbp5': {slug: 'bbp-fade-npc-list', image: 'bbp.png', color: '#217DD3', i18n: 'Fade NPC List', parent: 'bbp0', domain: 0, system: true},
      'bbp6': {slug: 'bbp-hide-npc-blacklist', image: 'bbp.png', color: '#217DD3', i18n: 'Hide NPC Blacklist', parent: 'bbp0', domain: 0, system: true},
      'bbp7': {slug: 'bbp-hide-npc-whitelist', image: 'bbp.png', color: '#217DD3', i18n: 'Hide NPC Whitelist', parent: 'bbp0', domain: 0, system: true},
      'bbp8': {slug: 'bbp-cast-emphasis-list', image: 'bbp.png', color: '#217DD3', i18n: 'Cast Emphasis List', parent: 'bbp0', domain: 0, system: true},
      'bbp9': {slug: 'bbp-hide-castbar-blacklist', image: 'bbp.png', color: '#217DD3', i18n: 'Hide Castbar Blacklist', parent: 'bbp0', domain: 0, system: true},
      'bbp10': {slug: 'bbp-hide-castbar-whitelist', image: 'bbp.png', color: '#217DD3', i18n: 'Hide Castbar Whitelist', parent: 'bbp0', domain: 0, system: true},
