...
<style>
#edit-elvui .md-select-content { max-height: calc(70vh); margin-bottom: 32px }
#edit-elvui .md-select { width: auto }
#edit-elvui .md-input-container { margin-bottom: 10px}
#edit-elvui .md-input-container:after { content: none }
#edit-elvui .flex-container { display: flex; flex-direction: row; flex-wrap: nowrap; align-items: flex-end}
#edit-elvui .flex-left { order: 0; flex: 0 1 auto}
#edit-elvui .flex-left .md-input-container label { white-space: nowrap}
#edit-elvui .flex-right { order: 1; flex: 1 1 auto; text-align: right}
#edit-elvui .ace_editor { box-shadow: 0 1px 5px rgba(0, 0, 0, 0.2), 0 2px 2px rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.12); }
</style>
