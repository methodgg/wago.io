        ...
        <div class="nav">
          ...
          <div class="menu-section" v-else>
            ...
            <div class="sub-nav">
              ...
              <div class="menu-group">
                <router-link to='/cell'><span class="addon-icon"><img src="./assets/menu-cell.png"></span> Cell <div class="newAlert"><span>{{ $t('New') }}</span></div></router-link>
